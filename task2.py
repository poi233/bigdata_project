...
street_pattern = "street,st,road,rd,ave,avenue,blvd,drive,court,place,pl,boulevard,way,parkway,av"
color_ab = "BK,BL,BR,GL,GY,MR,OR,PK,PR,RD,TN,WH,YW,LT,DK,NOCL".lower()
...
def is_car_make(x):
    return binary_search(car_make, x)
...
if __name__ == "__main__":
    ...
    for file in files:
        ...
        predicted_labels_without_column_name = get_predicted_labels(column_name_type, column_data_type, with_column_name=False)
